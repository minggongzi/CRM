...
class CustomerInfo(models.Model):
    ...
    status_choices=((0,'未报名'),(1,'已报名'),(2,'以退学'))
...
class ClassList(models.Model):
    ...
    start_date = models.DateField('开办日期')
...
class StudyRecord(models.Model):
    ...
    course_record = models.ForeignKey('CourRecord',on_delete=None)
    ...
    show_staus =models.SmallIntegerField(choices=show_choices,default=0)
...
class CourRecord(models.Model):
    ...
    has_homework = models.BooleanField('本届有作业',default=True)
